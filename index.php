            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="stock.php" class="nav-link text-white d-flex align-items-center gap-2">
                        <svg width="27" height="27" viewBox="0 0 1024 1024" fill="#ffffff" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                ...
                <li>
                    <a href="masuk.php" class="nav-link text-white">
